...
const nextSlide = () => {
  currentSlide.value = (currentSlide.value + 1) % cardImages.length
}

const prevSlide = () => {
  currentSlide.value = (currentSlide.value - 1 + cardImages.length) % cardImages.length
}
    ...
    <div class="flex flex-col xl:flex-row gap-6 lg:gap-8 p-6 items-start">
      ...
      <div class="flex flex-col gap-4 w-full xl:w-auto">
        ...
        <div class="flex items-center gap-3 justify-center">
          ...
          <div class="relative w-full max-w-[450px] lg:w-[450px] bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden" style="aspect-ratio: 450/628;">
