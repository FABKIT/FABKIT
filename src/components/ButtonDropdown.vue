  ...
  <Listbox as="div" v-model="selected"  @update:modelValue="value => emit('update:modelValue', value)">
    ...
    <div class="relative">
      ...
      <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
        <ListboxOptions class="absolute left-1/2 transform -translate-x-1/2 z-[100] mt-2 w-72 max-h-[calc(100vh-280px)] origin-top divide-y divide-gray-200 overflow-auto rounded-md bg-white dark:bg-dark shadow-lg ring-1 ring-black/5 dark:ring-white/5 focus:outline-hidden">
