...
<template>
  <footer class="dark:bg-dark sticky top-[100vh] pt-3 border-t border-t-primary">
    <div class="mx-auto max-w-7xl px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div>
        <p class="mt-8 text-left text-sm/6 text-primary md:order-1 md:mt-0">FABKIT is in no way affiliated with Legend Story Studios. Legend Story Studios®, Flesh and Blood™, and set names are trademarks of Legend Story Studios. Flesh and Blood characters, cards, logos, and art are property of Legend Story Studios. Card Images © Legend Story Studios</p>
        <p class="mt-8 text-left text-sm/6 text-primary md:order-1 md:mt-0">Developed by Thencros & Lambstream</p>
      </div>
    </div>
  </footer>
</template>
